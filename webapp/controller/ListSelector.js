sap.ui.define([
		...
		return BaseObject.extend("de.fis.filebrowser.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias de.fis.filebrowser.model.ListSelector
			 */
			 ...
			 * @return {de.fis.filebrowser.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
