							...
							success : function (aEntitySet) {
								...
								return this.waitFor({
									...
									check: function (oList) {
										...
										var sObjectID = oList.getBindingContext().getProperty("ApplicantId");

										var iLength = aEntitySet.filter(function (oLineItem) {
											return oLineItem.ApplicantId === sObjectID;
										}).length;
						...
						return this.waitFor({
							...
							success : function (oList) {
								...
								return this.waitFor({
									id : "lineItemsHeader",
									viewName : sViewName,
									matchers : new PropertyStrictEquals({name: "text", value: "Applications (" + iNumberOfItems + ")"}),
									success : function () {
