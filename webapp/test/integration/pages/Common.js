sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("de/fis/filebrowser/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("de.fis.filebrowser.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["de/fis/filebrowser/localService/mockserver"], function (mockserver) {
